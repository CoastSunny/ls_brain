...
%             1-re-order increaseing, 0-do nothing, -1=re-order decreasing
...
%  calibrate- [str] calibrate the final classifier predictions using;    ('bal')
%               ''   -- no calibration
...
opts = struct('binsp',1,'aucNoise',0,'recSoln',0,'dim',[],...
              'reuseParms',1,'seed',[],'seedNm','alphab','verb',-1,'reorderC',1,...
