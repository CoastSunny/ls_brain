...
%%%%%%%%%%%%%% BOTH O+R ==f , Actual %%%%%%%%%%%%%%%%%%%%%%%%%%%%
scores_nirs = getwindowscoresR(Nf(:,6,pa_subj),[],'+','+',windn);
...
%2nd window
scores_nirs = getwindowscoresR(Nf(:,6,pa_subj),[],'+',[],windn,[]);
scores_eeg = getwindowscoresR(Ef(:,2,pa_subj),[],'-',[],winde,[]);
scores_comb = getwindowscoresR(Ef(:,2,pa_subj),Nf(:,6,pa_subj),'-','+',winde,windn);

Tnaverage_nirsAMf = scores_nirs.comb_rate;
Tnaverage_eegAM = scores_eeg.comb_rate;
Tnaverage_combAMf = scores_comb.comb_rate;

%TdivAMf = getdiversity(Nf(:,6,pa_subj),Ef(:,2,pa_subj));
%%%%%%%%%%%%%%%%%%%%%%%%% Imaginary %%%%%%%%%%%%%%%%%%
scores_nirs = getwindowscoresR(Nf(:,5,pa_subj),[],'+','+',windn);
...
%2nd window
scores_nirs = getwindowscoresR(Nf(:,5,pa_subj),[],'+',[],windn,[]);
scores_eeg = getwindowscoresR(Ef(:,1,pa_subj),[],'-',[],winde,[]);
scores_comb = getwindowscoresR(Ef(:,1,pa_subj),Nf(:,5,pa_subj),'-','+',winde,windn);

Tnaverage_nirsIMf = scores_nirs.comb_rate;
Tnaverage_eegIM = scores_eeg.comb_rate;
Tnaverage_combIMf = scores_comb.comb_rate;

%TdivIMf = getdiversity(fnirsIMf,-feegIM);

%%%%%%%%%%%%%% R ==d %%%%%%%%%%%%%%%%%%%%%%%%%%%%
scores_nirs = getwindowscoresR(Nf(:,4,pa_subj),[],'+','+',windn);
...
scores_nirs = getwindowscoresR(Nf(:,4,pa_subj),[],'+',[],windn,[]);
scores_eeg = getwindowscoresR(Ef(:,2,pa_subj),[],'-',[],winde,[]);
scores_comb = getwindowscoresR(Ef(:,2,pa_subj),Nf(:,4,pa_subj),'-','+',winde,windn);

Tnaverage_nirsAMd = scores_nirs.comb_rate;
Tnaverage_eegAM = scores_eeg.comb_rate;
Tnaverage_combAMd = scores_comb.comb_rate;


%TdivAMd = getdiversity(fnirsAMd,-feegAM);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
scores_nirs = getwindowscoresR(Nf(:,3,pa_subj),[],'+','+',windn);
...
scores_nirs = getwindowscoresR(Nf(:,3,pa_subj),[],'+',[],windn,[]);
scores_eeg = getwindowscoresR(Ef(:,1,pa_subj),[],'-',[],winde,[]);
scores_comb = getwindowscoresR(Ef(:,1,pa_subj),Nf(:,3,pa_subj),'-','+',winde,windn);

Tnaverage_nirsIMd = scores_nirs.comb_rate;
Tnaverage_eegIM = scores_eeg.comb_rate;
Tnaverage_combIMd = scores_comb.comb_rate;

%TdivIMd = getdiversity(fnirsIMd,-feegIM);

%%%%%%%%%%%%%%  Oxy == o   %%%%%%%%%%%%%%%%%%%%%%%%%%%%

scores_nirs = getwindowscoresR(Nf(:,2,pa_subj),[],'+','+',windn);
...
scores_nirs = getwindowscoresR(Nf(:,2,pa_subj),[],'+',[],windn,[]);
scores_eeg = getwindowscoresR(Ef(:,2,pa_subj),[],'-',[],winde,[]);
scores_comb = getwindowscoresR(Ef(:,2,pa_subj),Nf(:,2,pa_subj),'-','+',winde,windn);

Tnaverage_nirsAMo = scores_nirs.comb_rate;
Tnaverage_eegAM = scores_eeg.comb_rate;
Tnaverage_combAMo = scores_comb.comb_rate;

%TdivAMo = getdiversity(fnirsAMo,-feegAM);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
scores_nirs = getwindowscoresR(Nf(:,1,pa_subj),[],'+','+',windn);
...
scores_nirs = getwindowscoresR(Nf(:,1,pa_subj),[],'+',[],windn,[]);
scores_eeg = getwindowscoresR(Ef(:,1,pa_subj),[],'-',[],winde,[]);
scores_comb = getwindowscoresR(Ef(:,1,pa_subj),Nf(:,1,pa_subj),'-','+',winde,windn);

Tnaverage_nirsIMo = scores_nirs.comb_rate;
Tnaverage_eegIM = scores_eeg.comb_rate;
Tnaverage_combIMo = scores_comb.comb_rate;
