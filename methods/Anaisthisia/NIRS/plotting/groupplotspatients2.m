...
%t8=patients.all.default.plot('classes',am,'channels',channel,'blocks_in',8,'vis','off');
...
scaleOA=[norm(t1.avg) norm(t2.avg) norm(t3.avg) norm(t4.avg)...
    norm(t5.avg) norm(t6.avg) norm(t7.avg)];
scaleOA(remove)=[];
...
title('Group averaged HbO and HbR for patients and attempted movement');
...
%t8=patients.all.default.plot('classes',im,'channels',channel,'blocks_in',8,'vis','off');
...
xlabel('time in seconds')
ylabel('normalised concentration change')
title('Group averaged HbO and HbR for patients and imagined movement');
line([-5 25],[0 0],'Color','k','LineStyle',':','LineWidth',3)
% NO MOVEMENT %%
channel={'nirs_o2hba' 'nirs_o2hbb'};
...
%t8=patients.all.default.plot('classes',rest,'channels',channel,'blocks_in',8,'vis','off');
...
xlabel('time in seconds')
ylabel('normalised concentration change')
title('Group averaged HbO and HbR for patients and no movement');
line([-5 25],[0 0],'Color','k','LineStyle',':','LineWidth',3)
