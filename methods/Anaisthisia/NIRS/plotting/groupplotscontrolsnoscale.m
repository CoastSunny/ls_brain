...
figure,hold on,shadedErrorBar(t,mean(OR.avg),mean(OR.var).^(1/2),'r',1),shadedErrorBar(t,mean(HR.avg),mean(HR.var).^(1/2),'g',1)
axis(ax);
...
%figure,hold on,shadedErrorBar(t,C1.avg,C1.var.^(1/2),'r',1),shadedErrorBar(t,C2.avg,C2.var.^(1/2),'g',1)
figure,hold on,shadedErrorBar(t,mean(OI.avg),mean(OI.var).^(1/2),'r',1),shadedErrorBar(t,mean(HI.avg),mean(HI.var).^(1/2),'g',1)
axis(ax);
...
%figure,hold on,shadedErrorBar(t,C1.avg,C1.var.^(1/2),'r',1),shadedErrorBar(t,C2.avg,C2.var.^(1/2),'g',1)
figure,hold on,shadedErrorBar(t,mean(OA.avg),mean(OA.var).^(1/2),'r',1),shadedErrorBar(t,mean(HA.avg),mean(HA.var).^(1/2),'g',1)
axis(ax);
...
trax=(-49:150)/10;
ax2=[-5 15 -1 1];
figure,subplot(2,1,1),hold on,plot(trax,mean(OA.avg(:,trtime)),'k'),plot(trax,mean(OR.avg(:,trtime)),'k-.'),axis(ax2)
subplot(2,1,2),imagesc(pOA),colormap(cmap),axis off
figure,subplot(2,1,1),hold on,plot(trax,mean(HA.avg(:,trtime)),'k'),plot(trax,mean(HR.avg(:,trtime)),'k-.'),axis(ax2)
subplot(2,1,2),imagesc(pHA),colormap(cmap),axis off

figure,subplot(2,1,1),hold on,plot(trax,mean(OI.avg(:,trtime)),'k'),plot(trax,mean(OR.avg(:,trtime)),'k-.'),axis(ax2)
subplot(2,1,2),imagesc(pOI),colormap(cmap),axis off
figure,subplot(2,1,1),hold on,plot(trax,mean(HI.avg(:,trtime)),'k'),plot(trax,mean(HR.avg(:,trtime)),'k-.'),axis(ax2)
