...
bciroot = {'/Users/louk/Data/Raw/' '/home/louk/Data/' '/media/LoukStorage/Raw' '/media/F2786FA2786F63F7/loukstorage/Raw'};
...
%     z.X=fftfilter(z.X,filt,[0 len],2,1);
    ...
    z.X=ls_whiten(z.X,method,L,trdim,T,time_window,freqband);
    %%
    %%
