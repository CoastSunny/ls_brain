...
bias_savC=zeros(1,10);bias_sav=zeros(1,10);bias_nrow=zeros(1,10);bias_nrowC=zeros(1,10);
cheating_bias=0;fpr_target=0.01;tp=0.01;
...
code_louk_justdata
outplos=out;outplos2=out2;
outplos_switch=out_switch;
outplos_nrow=out_nrow;outplos2_nrow=out2_nrow;
...
out=outplos;out2=outplos2;
out_switch=outplos_switch;
out_nrow=outplos_nrow;out2_nrow=outplos2_nrow;
