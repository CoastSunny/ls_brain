...
zs(ci)=jf_windowData(zs(ci),'dim','time','start_ms',0:1000:3000,'width_samp',128);
...
% cut the data into 128 sample bits every 1000ms
zs(ci)=jf_windowData(zs(ci),'dim','time','start_ms',0:1000:5000,'width_samp',128);
...
% cut the data into 128 sample bits every 1000ms
zs(ci)=jf_windowData(zs(ci),'dim','time','start_ms',0:1000:11000,'width_samp',128);
