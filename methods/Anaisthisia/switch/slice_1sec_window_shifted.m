...
zs(ci)=jf_windowData(zs(ci),'dim','time','start_ms',250,'width_samp',128);
...
% cut the data into 128 sample bits every 1000ms
zs(ci)=jf_windowData(zs(ci),'dim','time','start_ms',250+(0:1000:2000),'width_samp',128);
...
% cut the data into 128 sample bits every 1000ms
zs(ci)=jf_windowData(zs(ci),'dim','time','start_ms',250+(0:1000:8000),'width_samp',128);
...
% setup 2 sub-problems
% cut the data into 128 sample bits every 1000ms
zs(ci)=jf_windowData(zs(ci),'dim','time','start_ms',250+(0:1000:59000),'width_samp',128);
...
z=jf_save(z,'1s_windows_shifted');
