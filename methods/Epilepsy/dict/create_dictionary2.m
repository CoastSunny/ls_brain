%This function creates the dictionary but removes the amplitude and
%frequency componens of atoms when reconstructing with chirplets
function [D,P,D_chirp,D_chirp_rb]=create_dictionary2()
    ...
    for i=1:size(spike_location,2)
        ...
        D1=find_chirplets(D(i,:),n);
        D1(:,1)=1;
        D1(:,3)=1;
        P(i,:)=reshape(D1,[1 5*n]);
%         'D'
%         size(D,2)
