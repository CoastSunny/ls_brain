function [res]=gemi_scl( source, target)
...
for i=1:numel(members)
    if ( strcmp( class( target.( members{ i } ) ) , 'Subject' ) && ~strcmp( members{ i } , 'all' ) )
        [rated60150(i,1) rated60150(i,2)] = source.default.apply_classifier( target.(  members{i} ).default , 'name' , 'groupL' , 'target_markers'  , [20] , 'target_label' ,  1 );
        [rated60135(i,1) rated60135(i,2)] = source.default.apply_classifier( target.(  members{i} ).default , 'name' , 'groupL' , 'target_markers'  , [21] , 'target_label' ,  1 );
        [rated60120(i,1) rated60120(i,2)]  = source.default.apply_classifier( target.(  members{i} ).default , 'name' , 'groupL' , 'target_markers'  , [22] , 'target_label' ,  1 );
        [rates60(i,1) rates60(i,2)]  = source.default.apply_classifier( target.(  members{i} ).default , 'name' , 'groupL' , 'target_markers'  , [12] , 'target_label' , -1 );
        [rates150(i,1) rates150(i,2)] = source.default.apply_classifier( target.(  members{i} ).default , 'name' , 'groupL' , 'target_markers'  , [19] , 'target_label' , -1 );
        [rates135(i,1) rates135(i,2)] = source.default.apply_classifier( target.(  members{i} ).default , 'name' , 'groupL' , 'target_markers'  , [17] , 'target_label' , -1 );
        [rates120(i,1) rates120(i,2)] = source.default.apply_classifier( target.(  members{i} ).default , 'name' , 'groupL' , 'target_markers'  , [16] , 'target_label' , -1 );
    end
end
