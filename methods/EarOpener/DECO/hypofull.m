...
base={'blocks_in',1:200,'channels',32,'vis','off','time',1:307,'badrem','yes'};
...
for i=1:numel(subjects)
    ...
    CL240apspu= [a.avg' (s240.avg*s_L_delay)' (u.avg*u240_L_delay)'];
    CL240aspu= [as240.avg' (u.avg*u240_L_delay)'];%%dummy, nuisance, dont use!
    CL240apsu= [a.avg' (su240.avg*s_L_delay)'];
    CL240apu= [a.avg' (u.avg*u240_L_delay)'];
