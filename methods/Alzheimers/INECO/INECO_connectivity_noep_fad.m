...
%     data_folder='/home/engbiome/INECO/INECO_fieldtrip/';
    data_folder='/media/louk/Storage/Extracted/Alzheimer/INECO_fieldtrip/FAD_NOEP/';
    save_folder='/media/louk/Storage/Extracted/Alzheimer/INECO_fieldtrip/FAD_NOEP/';
end
