// mexGraphClustersList.cpp : Defines the entry point for the DLL application.
//

/****************************************************************************
function [ClustersList, varargout] = mexGraphClustersList(Graph,Direction)
...
%
% Returns: 
%	ClustersList - cellarray of 1D vectors	- Each cell represents a cluster disconnected from the other clusters and lists a nodes belongiong to that cluster.
%	ClusterSizes - vector of double			- (optional) If a placeholder for that parameter is provided, it lists the sizes of the clusters listed ClustersList in the same order.
% 
% See Also:
