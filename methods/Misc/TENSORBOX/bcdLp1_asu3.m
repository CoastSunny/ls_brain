...
% Decomposition of a tensor into a rank-1 tensor and multilinear-(R-1)
% tensor.
...
% CANDECOMP/PARAFAC. Part 1: Algorithms", submition for publication.
% [3] A.-H. Phan, P. Tichavsky, A. Cichocki, "Tensor Deflation for
% CANDECOMP/PARAFAC. Part 2: Initializations and Further Extensions",
% submition for publication. 
%
% See also: cp_als, 
%
% TENSOR BOX, v1. 2014
...
param.addOptional('init','tdiag',@(x) (iscell(x) ||...
    ismember(x(1:4),{'rand' 'nvec' 'fibe' 'orth' 'dtld' 'tdia' 'ceig' 'peig' 'osvd'})));
...
elseif ischar(param.init) && strcmp(param.init(1:min(ni,5)),'nvec2')
