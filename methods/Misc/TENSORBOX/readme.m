...
% CANDECOMP/PARAFAC or Tucker decomposition.
%
...
%
% Algorithms for rank-(L o 1) and rank-(L o M) block term decompositions, 
% decomposition of tensor into multiple Kronecker product terms (KTD),
% structured CPD will be available soon.
%
...
%  algorithms.
%  Please send email to Phan Anh-Huy (phan@brain.riken.jp)
