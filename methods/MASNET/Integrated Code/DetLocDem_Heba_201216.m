...
error_only_LOS_est = sqrt((t_x-T_est_los_x)^2+(t_y-T_est_los_y)^2);
error_only_LOS_iter = sqrt((t_x-T_iter_los_x)^2+(t_y-T_iter_los_y)^2);

error_only_LOS_est_pd = sqrt((t_x-T_est_los_pd_x)^2+(t_y-T_est_los_pd_y)^2);
error_only_LOS_iter_pd = sqrt((t_x-T_iter_los_x)^2+(t_y-T_iter_los_y)^2);

error_only_NLOS_est = sqrt((t_x-T_est_nlos_x )^2+(t_y-T_est_nlos_y)^2);
error_only_NLOS_iter = sqrt((t_x-T_iter_nlos_x)^2+(t_y-T_iter_nlos_y)^2);

error_only_NLOS_est_pd = sqrt((t_x-T_est_nlos_pd_x)^2+(t_y-T_est_nlos_pd_x)^2);
error_only_NLOS_iter_pd = sqrt((t_x-T_iter_nlos_x)^2+(t_y-T_iter_nlos_y)^2);

error_est = sqrt((t_x-T_est_x)^2+(t_y-T_est_y)^2);
error_iter = sqrt((t_x-T_iter_x)^2+(t_y-T_iter_y)^2);

error_est_pd = sqrt((t_x-T_est_pd_x)^2+(t_y-T_est_pd_y)^2);
error_iter_pd = sqrt((t_x-T_iter_pd_x)^2+(t_y-T_iter_pd_y)^2);
...
plot(T_est_los_x,T_est_los_y,'k+','MarkerSize',16); hold on
plot(T_iter_los_x,T_iter_los_y,'m+','MarkerSize',16); hold off
...
plot(T_est_los_pd_x ,T_est_los_pd_y,'k+','MarkerSize',16); hold on
plot(T_iter_los_pd_x,T_iter_los_pd_y,'m+','MarkerSize',16); hold off
...
plot(T_est_nlos_x ,T_est_nlos_y,'k*','MarkerSize',16); hold on
plot(T_iter_nlos_x,T_iter_nlos_y,'m*','MarkerSize',16); hold off
...
plot(T_est_nlos_pd_x,T_est_nlos_pd_y,'k*','MarkerSize',16); hold on
plot(T_iter_nlos_pd_x,T_iter_nlos_pd_y,'m*','MarkerSize',16); hold off
...
plot(Sensors(:,1),Sensors(:,2),'rx','MarkerSize',16); hold on
plot(t_x,t_y,'bo','MarkerSize',16);hold on
plot(T_est_x,T_est_y,'k*','MarkerSize',16); hold on
plot(T_iter_x,T_iter_y,'m*','MarkerSize',16); hold off
...
plot(T_est_pd_x,T_est_pd_y,'k*','MarkerSize',16); hold on
plot(T_iter_pd_x,T_iter_pd_y,'m*','MarkerSize',16); hold off
