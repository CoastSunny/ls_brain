function [varargout] = DelayPL(varargin)
...
% frequency.
%
% [CIR_out,d_round] = DelayPL(CIR_in, delays, d, f, Fs_desired)
%
...
%
% [CIR_out,d_round] = DelayPL(CIR_in, delays, d, f, Fs, 'PL_model')
%
...
Fs = 100e6;                 % As specified in WINNER II model.
NRx = size(CIR_in,1);
NTx = size(CIR_in,2);
Taps = size(CIR_in,3);
Temp = size(CIR_in,4);
